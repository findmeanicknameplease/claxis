-- =============================================================================
-- PREMIUM SAAS WEBHOOK & QUEUE TABLES
-- =============================================================================
-- Database schema for enterprise-grade webhook processing and message tracking
-- EU-compliant design with GDPR considerations (Frankfurt region)
-- Optimized for €299.99/month premium tier performance requirements
...
-- SELECT cron.schedule('cleanup-queue-logs', '0 2 * * *', 'SELECT cleanup_old_queue_logs();');
